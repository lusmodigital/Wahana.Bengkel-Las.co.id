...
# Article Guide — wahana.bengkel-las.co.id
...
Reader community name: `Bengkel-las.co.id`
...
- Address the reader warmly as `Sobat Bengkel-las.co.id`, `Kawan Bengkel-las.co.id`, or `Teman Bengkel-las.co.id`. Use the exact opening salutation assigned inside the article file.
